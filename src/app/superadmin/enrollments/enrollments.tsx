      ...
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 w-full sm:w-auto">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-xl bg-[#4DE8E0] px-4 py-2.5 text-sm font-semibold text-[#090C14] hover:bg-[#5FF0E8] transition-all w-full sm:w-auto"
          >
          ...
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 text-xs">
            ...
            {dateFilter === "CUSTOM" && (
              <input
                ...
                className="w-full sm:w-auto mt-1 sm:mt-0 px-3 py-1 bg-[#090C14] border border-[#4DE8E0]/40 text-[#4DE8E0] text-xs rounded-lg outline-none font-mono"
              />
            )}
          </div>
